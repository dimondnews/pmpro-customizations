	...
	<div id="pmpro_pricing_fields" class="pmpro_checkout">
		...
		<div class="pmpro_checkout-fields">
			...
			<div id="pmpro_level_cost">
				...
				<?php } ?>
				<?php
				$price = pmpro_getLevelCost($pmpro_level, true, true);
				$pieces = explode(" ", $price);				
				?>
				<?php echo wpautop("Annual membership: ".(string)$pieces[0]); ?>
			...
			<p>
				Membership is for a full year from date of dues payment.<br /><br />Look for the “sponsored member” code or link on your confirmation page.<br />Other household individuals signing up for membership can use this code to join for free.
				
			</p>
			<?php if($pmpro_show_discount_code) { ?>
				<?php if($discount_code && !$pmpro_review) { ?>
					<p id="other_discount_code_p" class=""><a id="other_discount_code_a" href="#discount_code"><?php _e('Click here to change your Sponsor Code', 'paid-memberships-pro' );?></a>.</p>
				<?php } elseif(!$pmpro_review) { ?>
					<p id="other_discount_code_p" class=""><?php _e('If you are joining as a sponsored member, ', 'paid-memberships-pro' );?> <a id="other_discount_code_a" href="#discount_code"><?php _e('click here to enter your sponsor code.', 'paid-memberships-pro' );?></a></p>
				<?php } elseif($pmpro_review && $discount_code) { ?>
					<p><strong><?php _e('Sponsor Code', 'paid-memberships-pro' );?>:</strong> <?php echo $discount_code?></p>
				<?php } ?>
			<?php } ?>

			<?php if($pmpro_show_discount_code) { ?>
			<div id="other_discount_code_tr" style="display: none;">
				<label for="other_discount_code"><?php _e('Sponsor Code', 'paid-memberships-pro' );?></label>
